...
public class MsgContract {
    ...
    private static String FieldNames[] = {
            "ZOID", "ZVER", "ZDATE", "ZUID", "ZSTA", "QR", "CONTRACTNUM",
            "contractdate", "MONEY", "SUPPLIER", "CLIENT", "PRODTYPE",
            "MODEL", "SN", "prodate", "shipdate", "SALEDATE",
            "DEPARTUREDATE", "WARRANTYSTART", "WARRANTYEND", "COMMENT"
    };
    private static String FieldCaptions[] = {
            "ZOID", "ZVER", "ZDATE", "ZUID", "ZSTA", "QR код", "№ договора", "дата договора",
            "Деньги по договору", "Юр-лицо поставщик", "Юр-лицо клиент", "Тип продукта",
            "Модель продукта", "SN", "Дата производства", "Дата ввоза (ГТД)", "Дата продажи",
            "Дата отправки клиенту", "Дата начала гарантии", "Дата окончания гарантии", "Комментарий (для клиента)"
    };
    ...
    public final static String[] CSV_UNSAFE_CHARACTERS_SUBST = {"\\.,", "\\.n", "\\.r","\\..n","\\..r"};
...
//
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < FieldNames.length; i++) {
            System.out.println(getFieldRow(i));
        }
